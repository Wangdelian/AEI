...
layui.use(['laypage', 'layer', 'form', 'laydate'], function () {
    ...
    form.on('submit(demo1)', function (data) {
        ...
        data.field.fdevicename = vm.recondition.fDevicename;
        data.field.freconditionstatus = vm.recondition.freconditionstatus;

        $.ajax({
            url: siteurl + '/train/recondition/update',
            type: 'POST',
...
var vm = new Vue({
    ...
    methods: {
        //获取详细信息
        getUserInfo: function (fid) {
            $.ajax({
                type: "GET",
                url: siteurl + '/train/recondition/info/' + fid,
                async: false,
                cache: false,
                dataType: "json",
                contentType: 'application/json;charset=UTF-8',
                success: function (r) {
                    vm.recondition = r.recondition;
                    vm.levelname = r.recondition.freconditionsite;
                    vm.fDevicename = r.recondition.fDevicename;
