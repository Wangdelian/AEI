layui.use(['table', 'layer', 'form', 'laydate'], function () {
    ...
    form.on('submit(export)', function () {
        var form = $("<form></form>").attr("action", siteurl + '/mqs/c1000/exportC1000').attr("method", "post");
    ...
    form.on('submit(generate)', function () {
        ...
        $.ajax({
            url: siteurl + '/mqs/c1000/generateC1000',
            type: "GET",
            dataType: "json",
    ...
    form.on('submit(deleteAndGenerate)', function () {
        index = parent.layer.load(0, {shade: 0.2});

        $.ajax({
            url: siteurl + '/mqs/c1000/deleteAndGenerate',
            type: "GET",
            dataType: "json",
            contentType: 'application/json;charset=UTF-8',
            success: function (r) {
...
/*    getSelectOptions(siteurl + '/mqs/mqsproductdept/addOption', {}, {
    ...
    function query(condition) {
        var dayList;
        setTimeout(function () {
            parent.layer.msg('查询C1000中', {offset: 'b'});
            ...
            $.ajax({
                ...
                success: function (r) {
                    ...
                    initC1000Table('#c1000-table', 'c1000-table-id', '', r.dayList, r.c1000Table1);
                }
            });
        }, 100);
        ...
        setTimeout(function () {
            ...
            $.ajax({
                ...
                contentType: 'application/json;charset=UTF-8',
                success: function (r) {
                    initC1000Table('#S', 'S-table-id', 'S类', dayList, r.fttTableS);
                }
            });
        }, 100);
        ...
        setTimeout(function () {
            ...
            $.ajax({
                ...
                contentType: 'application/json;charset=UTF-8',
                success: function (r) {
                    initC1000Table('#A', 'A-table-id', 'A类', dayList, r.fttTableA);
                }
            });
        }, 100);
        ...
        setTimeout(function () {
            ...
            $.ajax({
                ...
                contentType: 'application/json;charset=UTF-8',
                success: function (r) {
                    initC1000Table('#B', 'B-table-id', 'B类', dayList, r.fttTableB);
                }
            });
        }, 100)
        ...
        setTimeout(function () {
            ...
            $.ajax({
                ...
                contentType: 'application/json;charset=UTF-8',
                success: function (r) {
                    initC1000Table('#C', 'C-table-id', 'C类', dayList, r.fttTableC);
                }
            });
        }, 100);
        ...
        setTimeout(function () {
            ...
            $.ajax({
                ...
                contentType: 'application/json;charset=UTF-8',
                success: function (r) {
                    initC1000Table('#near-day', 'day-table-id', 'TOP10 ICCs-最近一天', dayList, r.fttTableOneDay);
                }
            });
        }, 100);
        ...
        setTimeout(function () {
            ...
            $.ajax({
                ...
                contentType: 'application/json;charset=UTF-8',
                success: function (r) {
                    initC1000Table('#near-month', 'month-table-id', 'TOP10 ICCs-最近一月', dayList, r.fttTableOneMonth);
                }
            });
        }, 100);
        ...
        setTimeout(function () {
            ...
            $.ajax({
                ...
                contentType: 'application/json;charset=UTF-8',
                success: function (r) {
                    initC1000Table('#near-year', 'year-table-id', 'TOP10 ICCs-最近一年', dayList, r.fttTableOneYear);
    ...
    function initC1000Table(elemId, tableId, tableDec, title, data) {
        table.render({
            elem: elemId
            , id: 'ftt-table-id'
            , data: data
