...
var vm = new Vue({
    ...
    methods: {
        ...
        getAndonReportList: function (pageNum,isResetPageNo) {
            ...
            $.ajax({
                type: "POST",
                url: siteurl+'/models/listbymodellist/'+pageNum,
        ...
        */
        ...
        //编辑操作
        op1:function(record)  {
            return '<a href="/modeler.html?modelId=' + gridObj.getRecordIndexValue(record, 'id') + '" "><font color="#010101">编辑</font></a>';
        },
        //删除操作
        op2:function (record) {
            return '<a href="/models/' + gridObj.getRecordIndexValue(record, 'id') + '" "><font color="#010101">删除</font></a>';
        }
    }
});
