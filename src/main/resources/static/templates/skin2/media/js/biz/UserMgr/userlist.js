...
//时间选择器
    ...
    window.initList = function (listdata) {
        table.render({
            ...
            , height: 'full-240'
            , cols: [[
                {templet: function (d) { return d.LAY_INDEX+(vm.currentPage-1)*20;} , width: '2%' }
                , {type: 'checkbox', width: '3%'}
                , {field: 'userId', title: '唯一ID', width: '8%', unresize: true, minWidth: 48,sort: true, align: 'center'}
                , {field: 'username', title: '登录名', width: '12%', templet: '#usernameTpl', minWidth: 48, align: 'center'}
                ...
                , {field: 'roleName', title: '角色名称', width: '17%', minWidth: 170, sort: true, align: 'center'}
                ...
                , {fixed: 'right', title: '操作', width: '12%', minWidth: 62, align: 'center', toolbar: '#barDemo'}
            ]]
            , page: false
            , limit: 20
        });
