...
import io.jeasyframework.dao.master.ScheduleJobDao;
import io.jeasyframework.entity.ScheduleJobEntity;
import io.jeasyframework.service.ScheduleJobService;
import io.jeasyframework.utils.Constant.ScheduleStatus;
import io.jeasyframework.utils.ScheduleUtils;
...
public class ScheduleJobServiceImpl implements ScheduleJobService {
	...
	@Override
	public List<ScheduleJobEntity> queryListCase(Map<String, Object> map){
		return schedulerJobDao.queryListCase(map);
	}
	@Override
	@Transactional
	...
	@Override
	public void deleteOne(Long jobIds){
		System.out.println("调用删除：----------ID："+jobIds);
		schedulerJobDao.deleteOne(jobIds);
	}
	@Override
