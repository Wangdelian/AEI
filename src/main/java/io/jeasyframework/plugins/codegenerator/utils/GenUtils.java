package io.jeasyframework.plugins.codegenerator.utils;

import io.jeasyframework.plugins.codegenerator.entity.ColumnEntity;
...
public class GenUtils {
    ...
    public static List<String> getTemplates(){
        ...
        templates.add("template/listv2.js.vm");
        return templates;
    }
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "io.jeasyframework" : mainPath;
        //封装模板数据
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("listv2.js.vm" )) {
            return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js" + File.separator
                    + "modules" + File.separator + moduleName + File.separator + className.toLowerCase() + "_v2.js";
        }
